...
export const PRICING_TABLE = [
  ...
  {
    size: '8*20*8', type: 'Unit', price: '$140.00', buttonText: 'Call for Availability', buttonLink: `tel:${PHONE.replace(/[^\d]/g, '')}`,
  },
  {
    size: '8*40*8', type: 'Unit', price: '$180.00', buttonText: 'Call for Availability', buttonLink: `tel:${PHONE.replace(/[^\d]/g, '')}`,
  },
  {
